    ...
    <Container>
      <Box sx={{ my: 4 }}>
        ...
        <FormControl fullWidth sx={{ mb: 2 }}>
          <InputLabel id='file-type-label' sx={{ color: 'black' }}>파일 유형</InputLabel>
          <Select
            ...
            sx={{ color: 'black' }}
          >
            <MenuItem value='수업' sx={{ color: 'black' }}>수업</MenuItem>
            <MenuItem value='학생' sx={{ color: 'black' }}>학생</MenuItem>
          </Select>
        </FormControl>
        {tabValue === 0 && (
          <>
            {fileType === '학생' && (
              <FormControl fullWidth sx={{ mb: 2 }}>
                <InputLabel id='course-label' sx={{ color: 'black' }}>수업</InputLabel>
                <Select
            ...
            {fileType === '학생' && (
              <FormControl fullWidth sx={{ mb: 2 }}>
                ...
                <Select
                  ...
                  sx={{ color: 'black' }}
                >
                  <MenuItem value='' sx={{ color: 'black' }}>모든 수업</MenuItem>
                  {courses.map(course => (
                    <MenuItem key={course.id} value={course.code} sx={{ color: 'black' }}>
                      {course.name}
                    </MenuItem>
